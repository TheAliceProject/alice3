...
class ECardPanel extends javax.swing.JPanel {
	...
	protected void setImage(CardState state) {
		...
		if (state == CardState.EMPTY) {
			this.image = new javax.swing.ImageIcon(ECardPanel.class.getResource("resources/card-empty.png")).getImage();
		} else if (state == CardState.PHOTO) {
			this.image = new javax.swing.ImageIcon(ECardPanel.class.getResource("resources/card-photo.png")).getImage();
		} else if (state == CardState.BUBBLE_PHOTO) {
			this.image = new javax.swing.ImageIcon(ECardPanel.class.getResource("resources/card-bubble-photo.png")).getImage();
		}
