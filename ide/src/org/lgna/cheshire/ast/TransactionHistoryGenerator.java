...
//	}
	public org.lgna.croquet.history.TransactionHistory generate( org.lgna.project.ast.UserMethod owner, org.lgna.project.ast.MethodInvocation methodInvocation ) {
		...
		org.alice.ide.croquet.models.declaration.ProcedureDeclarationOperation.getInstance( sharedDeclaringType ).generateAndAddToTransactionHistory( history, sharedDeclaringType, method );
