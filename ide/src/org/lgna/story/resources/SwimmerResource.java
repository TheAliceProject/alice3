...
public interface SwimmerResource extends JointedModelResource {
	...
	public static final org.lgna.story.resources.JointId NECK = new org.lgna.story.resources.JointId( null, SwimmerResource.class );
	...
	public static final org.lgna.story.resources.JointId PELVIS_UPPER_BODY = new org.lgna.story.resources.JointId( null, SwimmerResource.class );
	public static final org.lgna.story.resources.JointId SPINE_MIDDLE = new org.lgna.story.resources.JointId( PELVIS_UPPER_BODY, SwimmerResource.class );
	public static final org.lgna.story.resources.JointId SPINE_UPPER = new org.lgna.story.resources.JointId( SPINE_MIDDLE, SwimmerResource.class );
	...
	public static org.lgna.story.resources.JointId[] JOINT_ID_ROOTS = { NECK, PELVIS_UPPER_BODY };
