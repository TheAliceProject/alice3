...
public class AliceJointedModelImplementationFactory extends org.lgna.story.implementation.factories.JointedModelImplementationVisualFactory {
	private static java.util.Map< org.lgna.story.resources.JointedModelResource, AliceJointedModelImplementationFactory > map = edu.cmu.cs.dennisc.java.util.Collections.newHashMap();

	public static AliceJointedModelImplementationFactory getInstance( org.lgna.story.resources.JointedModelResource resource ) {
		synchronized( map ) {
	...
	private AliceJointedModelImplementationFactory( org.lgna.story.resources.JointedModelResource resource ) {
