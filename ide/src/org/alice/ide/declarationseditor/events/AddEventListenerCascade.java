...
import org.lgna.croquet.history.CascadeCompletionStep;
...
public class AddEventListenerCascade extends CascadeWithInternalBlank<MethodInvocation> {
	...
	@Override
	protected Edit<? extends Cascade<MethodInvocation>> createEdit(CascadeCompletionStep<MethodInvocation> completionStep, MethodInvocation[] values) {
