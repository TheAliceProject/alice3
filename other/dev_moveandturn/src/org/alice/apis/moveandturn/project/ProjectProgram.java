...
public class ProjectProgram extends org.alice.apis.moveandturn.Program {
	...
	public ProjectProgram( String path ) {
		...
		assert file.exists();
		this.project = edu.cmu.cs.dennisc.alice.io.FileUtilities.readProject(file);
	...
	public static void main(String[] args) {
		...
		if( args.length > 0 ) {
			...
			path = edu.cmu.cs.dennisc.alice.io.FileUtilities.getMyProjectsDirectory().getAbsolutePath() + "/a.a3p";
		}
