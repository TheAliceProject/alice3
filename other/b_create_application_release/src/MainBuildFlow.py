...
USE_WALK_AND_TOUCH_JAR = True
FORCE_NEW_VERSION = True
FORCE_NEW_COMPONENTS = False
OLD_VERSION = VersionUtilities.VersionNum("3.0.0.0.64")
NEW_VERSION = VersionUtilities.VersionNum("3.0.0.0.65")

WEB_DATA_URL = "http://www.alice.org/downloads/test/installerData"
...
#		    elif (USE_WALK_AND_TOUCH_JAR and buildObject.name == "lg_walkandtouch"):
#			if (buildObject.forceFromExistingVersion(NEW_VERSION, JAR_SRC_DIR + "jar_walkandtouch/lg_walkandtouch.jar")):
...
#	installer = InstallerUtilities.InstallerProject("AliceInstaller", newVersionNum, WEB_DATA_URL)
#
#	mainInstallers = []
#	closerInstallers = []
...
PLUGIN_NEW_VERSION = VersionUtilities.VersionNum("3.0.0.65.0")
plugin = NetbeansPluginUtilities.PluginObject(ALICE_PLUGIN_FOLDER, PLUGIN_NEW_VERSION, "C:/AliceDistribution/ext/jogl/lib")
#plugin.getJars(jarObjects)
plugin.getJarsFromPaths("C:/AliceVersions/3.0.0.0.65/lib/3.0.0.0.65/foundation.jar", "C:/AliceVersions/3.0.0.0.65/lib/3.0.0.0.65/lg_walkandtouch.jar", "C:/AliceVersions/3.0.0.0.65/lib/3.0.0.0.65/moveandturn.jar", "C:/AliceVersions/3.0.0.0.65/lib/3.0.0.0.65/stage.jar")
plugin.getLibraries("C:/AliceNative/WindowsNative/application/windows-i586/", "C:/AliceNative/WindowsNative/application/windows-amd64/", "C:/AliceNative/MacNative/application/macosx-universal/", "C:/AliceNative/MacNative/application/macosx-10.4/", "C:/AliceNative/LinuxNative/application/linux-i586/", "C:/AliceNative/LinuxNative/application/linux-amd64/")
plugin.makeNBMs()
