...
public class texture extends State {
  ...
  public void init(String name, Attributes attrs, StateManager mngr) {
    ...
    this.theTexture = new Texture(attrs.getValue("texture"), attrs.getValue("texcoord"));

    State parent = getParent();
    try {
      Method method = parent.getClass().getMethod("getAttrib", new Class[0]);
      EffectAttribute attrib = (EffectAttribute) method.invoke(parent, new Object[0]);
