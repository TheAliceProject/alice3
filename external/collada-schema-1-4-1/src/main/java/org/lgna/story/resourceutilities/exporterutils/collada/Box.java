...
@XmlRootElement(name = "box", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class Box {

    @XmlList
    @XmlElement(name = "half_extents", namespace = "http://www.collada.org/2005/11/COLLADASchema", type = Double.class)
