...
@XmlRootElement(name = "library_physics_materials", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class LibraryPhysicsMaterials {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema")
    protected Asset asset;
    @XmlElement(name = "physics_material", namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
