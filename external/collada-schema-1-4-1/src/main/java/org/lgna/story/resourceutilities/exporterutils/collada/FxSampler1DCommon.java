...
@XmlType(name = "fx_sampler1D_common", namespace = "http://www.collada.org/2005/11/COLLADASchema", propOrder = {
    "source",
    "wrapS",
    "minfilter",
    "magfilter",
...
public class FxSampler1DCommon {
    ...
    @XmlElement(name = "mipmap_maxlevel", namespace = "http://www.collada.org/2005/11/COLLADASchema", defaultValue = "0")
