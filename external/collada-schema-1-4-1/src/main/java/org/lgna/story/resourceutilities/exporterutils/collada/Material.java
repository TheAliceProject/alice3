...
@XmlRootElement(name = "material", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class Material {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema")
    protected Asset asset;
    @XmlElement(name = "instance_effect", namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
