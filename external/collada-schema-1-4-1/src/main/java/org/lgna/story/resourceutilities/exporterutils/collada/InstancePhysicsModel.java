...
@XmlRootElement(name = "instance_physics_model", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class InstancePhysicsModel {
    ...
    @XmlElement(name = "instance_rigid_body", namespace = "http://www.collada.org/2005/11/COLLADASchema")
    protected List<InstanceRigidBody> instanceRigidBody;
    @XmlElement(name = "instance_rigid_constraint", namespace = "http://www.collada.org/2005/11/COLLADASchema")
