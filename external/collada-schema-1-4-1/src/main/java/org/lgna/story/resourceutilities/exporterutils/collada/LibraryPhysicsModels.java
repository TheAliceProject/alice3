...
@XmlRootElement(name = "library_physics_models", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class LibraryPhysicsModels {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema")
    protected Asset asset;
    @XmlElement(name = "physics_model", namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
