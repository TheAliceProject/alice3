...
@XmlRootElement(name = "library_force_fields", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class LibraryForceFields {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema")
    protected Asset asset;
    @XmlElement(name = "force_field", namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
