...
@XmlRootElement(name = "instance_controller", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class InstanceController {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema")
    @XmlSchemaType(name = "anyURI")
    protected List<String> skeleton;
    @XmlElement(name = "bind_material", namespace = "http://www.collada.org/2005/11/COLLADASchema")
