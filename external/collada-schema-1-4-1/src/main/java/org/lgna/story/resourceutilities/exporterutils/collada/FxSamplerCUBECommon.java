...
@XmlType(name = "fx_samplerCUBE_common", namespace = "http://www.collada.org/2005/11/COLLADASchema", propOrder = {
    "source",
    "wrapS",
    "wrapT",
    "wrapP",
...
public class FxSamplerCUBECommon {
    ...
    @XmlElement(name = "wrap_p", namespace = "http://www.collada.org/2005/11/COLLADASchema", defaultValue = "WRAP")
    @XmlSchemaType(name = "NMTOKEN")
