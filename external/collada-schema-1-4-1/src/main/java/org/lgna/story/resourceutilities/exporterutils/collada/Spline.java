...
@XmlRootElement(name = "spline", namespace = "http://www.collada.org/2005/11/COLLADASchema")
public class Spline {

    @XmlElement(namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
    protected List<Source> source;
    @XmlElement(name = "control_vertices", namespace = "http://www.collada.org/2005/11/COLLADASchema", required = true)
