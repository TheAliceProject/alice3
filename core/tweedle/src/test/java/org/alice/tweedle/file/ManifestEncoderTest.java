...
public class ManifestEncoderTest {
  private static final String SAMPLE_LIBRARY = "{ \"description\": {" + " \"name\": \"Alice SThing Library\", \"icon\": \"thumbnail.png\", \"tags\": []," + " \"groupTags\": [], \"themeTags\": [] }, \"metadata\": {" + " \"formatVersion\": \"0.1\", \"identifier\": { \"id\": \"SystemLibrary\"," + " \"type\": \"Library\", \"version\": \"0.7\" } }," + " \"provenance\": { \"aliceVersion\": \"3.4.1.0\", \"created\": \"2018\"," + " \"creator\": \"Not Dennis\" }, \"prerequisites\": []}";

  private static final String LIBRARY_WITH_DATE = "{ \"description\": {" + " \"name\": \"Alice SThing Library\", \"icon\": \"thumbnail.png\", \"tags\": []," + " \"groupTags\": [], \"themeTags\": [] }, \"metadata\": {" + " \"formatVersion\": \"0.1\", \"identifier\": { \"id\": \"SystemLibrary\"," + " \"type\": \"Library\", \"version\": \"0.7\" } }," + " \"provenance\": { \"aliceVersion\": \"3.4.1.0\", \"created\": \"2010-01-01T12:00:00+01:00\"," + " \"creator\": \"Not Dennis\" }, \"prerequisites\": []}";

  private static final String SAMPLE_MODEL =
      "{ \"description\": {" + " \"name\": \"Alien\", \"icon\": \"thumbnail.png\"," + " \"tags\": [ \"alien\", \"space\" ], \"groupTags\": [ \"characters\" ]," + " \"themeTags\": [ \"*outer space\" ] }, \"package\": {" + " \"formatVersion\": \"0.1\", \"identifier\": { \"id\": \"Alien\"," + " \"type\": \"Model\", \"version\": \"1.0\" } }," + " \"provenance\": { \"aliceVersion\": \"3.4.1.0\", \"created\": \"2011\"," + " \"creator\": \"Laura Paoletti\" }, \"rootJoints\": [ \"ROOT\" ]," + " \"additionalJoints\": [" + " { \"name\": \"LOWER_LIP\", \"parent\": \"MOUTH\", \"visibility\": \"completelyHidden\" }" + " ], \"additionalJointArrays\": [], \"poses\": [], \"boundingBox\": {" + " \"min\": [ \"-0.2\", \"7.2\", \"-0.1\" ]," + " \"max\": [ \"0.2\", \"1.4\", \"0.3\" ] },"
          + " \"textureSets\": [ { \"id\": \"default\"," + " \"contentType\": \"image\", \"format\": \"png\"," + " \"files\": [ \"alien_diffuse.png\" ] } ], \"structures\": [ {" + " \"id\": \"default\", \"contentType\": \"skeleton-mesh\"," + " \"format\": \"collada\", \"files\": [\"alien.dae\"], \"boundingBox\": {" + " \"min\": [ \"-0.2\", \"7.2\", \"-0.1\" ]," + " \"max\": [ \"0.2\", \"1.4\", \"0.3\" ]" + " } } ], \"models\": [ { \"skeleton\": \"default\"," + " \"textureSet\": \"default\", \"icon\": \"thumbnail.png\" } ]}";
