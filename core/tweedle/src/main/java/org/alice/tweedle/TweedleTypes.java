...
public class TweedleTypes {
  ...
  public static final TweedlePrimitiveType[] PRIMITIVE_TYPES = {NUMBER, DECIMAL_NUMBER, WHOLE_NUMBER, BOOLEAN, TEXT_STRING};
  ...
  public static TweedlePrimitiveType commonNumberType(TweedleExpression lhs, TweedleExpression rhs) {
    if (lhs == null || rhs == null || lhs.getType() == null || rhs.getType() == null || TweedleTypes.NUMBER.equals(lhs.getType()) || TweedleTypes.NUMBER.equals(rhs.getType())) {
