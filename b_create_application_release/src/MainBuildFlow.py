...
OLD_VERSION = VersionUtilities.VersionNum("3.0.0.0.58")
NEW_VERSION = VersionUtilities.VersionNum("3.0.0.0.59")
...
#plugin.getLibraries("C:/AliceNative/WindowsNative/application/windows-i586/", "C:/AliceNative/MacNative/application/macosx-universal/")
#plugin.makeNBMs()
